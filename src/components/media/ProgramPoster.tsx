...
/* Affiche avec repli dégradé (aucune image cassée) */
export function ProgramPoster({ program, className = "" }: { program: Program; className?: string }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-25" style={{ background: `radial-gradient(circle at 30% 20%, ${meta.color}55, transparent 55%)` }} aria-hidden />
