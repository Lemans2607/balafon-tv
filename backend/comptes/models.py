...
# 1. Nouveau gestionnaire personnalisé pour gérer l'identification par email uniquement
...
# 2. Votre modèle Utilisateur mis à jour
class Utilisateur(AbstractUser):
    ...
    # Lier le gestionnaire d'identification par email (TRÈS IMPORTANT)
